const ApiKey = "6f0225c23dee43cba55f0a7513f468c9";
...
const teamInfo = document.getElementById("details");
...
function getListTeams() {
	...
	fetch(teamEndPoin, fetchHeader)
        ...
        <li class="collection-item avatar">
            ...
            <a href="#modalDetails" id="${team.id}" class="secondary-content btn-tim modal-trigger"><i id="${team.id}" class="material-icons">info</i></a>
        </li>
        `;
			});
	...
	fetch(`https://api.football-data.org/v2/teams/${id}`, fetchHeader)
		...
		.then((result) => {
          ...
          <tr>
			...
			let teamInfoHTML = ` <div class="row">
      <div class="col m12">
        <div style="display: flex;
          align-items: center;">
          <img style="width:25%;" src="${result.crestUrl}" alt="" />
          <h4 style="font-weight: bold; margin-left: 20px;">${result.name}</h4>
        </div>
        <p style="margin-top: 30px; font-weight: bold; text-align: center;">INFORMASI TIM</p>
